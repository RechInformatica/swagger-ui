  ...
  tests.forEach(function(test) {
    it("passes " + test.expected.request + " to Curl when showMutatedRequest = " + test.showMutatedRequest, function() {
      ...
      expect(duration.html())
        .toEqual("<div><h5>Tempo da request</h5><pre class=\"microlight\">50 ms</pre></div>")
      ...
      expect(responseHeaders.html())
        .toEqual("<div><h5>Headers da resposta</h5><pre class=\"microlight\"><span class=\"headerline\"> content-type: application/xml </span></pre></div>")
    })
  })
})
